...
const ProductCard = ({
    ...
    return <MaxWidthContainer>
        ...
        <Image alt={title1 + " " + title2} className="w-full rounded-lg sm:hidden" src={mobileImage} width="327" height="352" />
        <Image alt={title1 + " " + title2} className="w-full rounded-lg hidden sm:block xl:hidden" src={tabletImage} width="800" height="440" />
        <Image alt={title1 + " " + title2} className={cn("w-full rounded-lg hidden xl:block", isReversed && "sm:order-1")} src={desktopImage} width="560" height="560" />
        <div className={cn(

      ...
      <section className="w-full space-y-6 sm:space-y-8 xl:space-y-12">
        <article className="relative rounded-lg w-full xl:gap-25 overflow-hidden bg-primary text-white flex flex-col xl:flex-row items-center justify-center py-16">
          ...
          <div className="text-center xl:text-start z-10">
            <h2 className="text-h2 xl:text-h1 uppercase font-bold mb-4 xl:mb-6">
              zx9
              <br />
              speaker
            </h2>
            <p className="max-w-87.5 mb-4 sm:mb-10">
        ...
        <article className="relative flex flex-col overflow-hidden object-contain aspect-square sm:h-80 sm:w-full sm:aspect-auto rounded-lg bg-light px-6 sm:px-16 xl:px-24 py-10">
          ...
          />
          <Image
            className="z-0 object-cover hidden sm:block xl:hidden w-full h-full"
            fill
            alt="zx7 speaker"
            src="/home/tablet/image-speaker-zx7.jpg"
          />
          <Image
            className="z-0 object-cover hidden xl:block w-full h-full"
            fill
            alt="zx7 speaker"
        ...
        <article className="grid grid-cols-1 sm:grid-cols-2 sm:flex-row gap-6 sm:gap-2.5">
          <Image
            ...
            height="200"
            alt="yx1 earphones"
            className="rounded-lg w-full sm:hidden"
          ...
          <Image
            ...
            height="320"
            alt="yx1 earphones"
            className="rounded-lg hidden w-full sm:block xl:hidden"

    ...
    return <header className={cn(
        ...
        <MaxWidthContainer className={cn(
            ...
            <Button className="lg:hidden" variant="ghost">
                <Image src="/shared/tablet/icon-hamburger.svg" className="me-auto" width="24" height="24" alt="Hamburger menu" />
            </Button>
            ...
            <Link className="ms-auto" href="">
                <Image src="/shared/desktop/icon-cart.svg" width="24" height="24" alt="Hamburger menu" />
            </Link>
        </MaxWidthContainer>
    </header>
}
